...
<h5 class="card-title" >Sửa Thông tin sinh viên</h5>
<form action="{{url('/admin/sv/update/'. $Sv->id)}}" method="post">
</div>
<div class="card-body">
...
<input type="text" class="form-control" id="inputEmail4"  name="hovaten" value="{{ $Sv->hovaten}}" >
</div>
@csrf

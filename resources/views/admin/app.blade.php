...
<body>
	<div class="wrapper">
		<nav id="sidebar" class="sidebar">
          ...
          <span class="align-middle">AdminKit</span>
              ...
              <i class="align-middle" data-feather="briefcase"></i> <span class="align-middle">BT</span>
            </a>
						<ul id="ui" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
							<li class="sidebar-item"><a class="sidebar-link" href="{{url('/admin/khoa')}}">Khoa</a></li>
							<li class="sidebar-item"><a class="sidebar-link" href="{{url('/admin/lop')}}">Lớp</a></li>
							<li class="sidebar-item"><a class="sidebar-link" href="{{url('/admin/sv')}}">Sinh viên</a></li>
						</ul>
					</li>
					<li class="sidebar-item">
						<a class="sidebar-link" href="#">
              <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Control</span>
            </a>
					</li>
	...
	<script src="{{asset('public/js/appp.js')}}"></script>
